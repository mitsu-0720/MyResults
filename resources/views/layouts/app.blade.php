                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                ...
                                <guestlogin-component></guestlogin-component>
                            </li>
                            <li class="nav-item">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link mt-2 mr-1" href="{{ action('TagsController@search') }}"><i class="fas fa-hashtag text-dark fs-24"></i></a>
                            </li>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt mr-2"></i>ログアウト</a>
